...
public class EasyScoreboard {
    ...
    private final EasyScoreboardManager scoreboardManager;
    
    public EasyScoreboard(final EasyScoreboardManager scoreboardManager,final Player p, final String title, final String... values) {
        this.p = p;
    ...
    public EasyScoreboard(final EasyScoreboardManager scoreboardManager, final Player p, final String title){
        this.p = p;
        this.scoreboardManager = scoreboardManager;
