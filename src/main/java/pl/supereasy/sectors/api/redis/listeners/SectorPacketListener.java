...
public class SectorPacketListener<T extends String> implements RedisListener<T> {
    ...
    public SectorPacketListener(PubSubType type, RTopic redisTopic) {
        this.type = type;
    ...
    public void sendMessage(T message) {
        ...
        SectorPlugin.getInstance().getRedissonClient().getTopic(split[0])
                .publish(split[1]);
    }
}